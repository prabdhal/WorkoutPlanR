...
namespace WorkoutPlannerWebApp.Controllers.Api
{
  public class WorkoutProgramsController : Controller
  {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Difficulty,ShortDescription,LongDescription,CreatedOn,UpdatedOn,Published")] WorkoutProgram workoutProgram)
    {
    ...
    {
      var workoutProgram = _context.WorkoutPrograms.FirstOrDefault(p => p.Id == id);
